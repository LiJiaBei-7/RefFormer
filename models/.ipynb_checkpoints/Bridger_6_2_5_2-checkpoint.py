...
from .layers_6_2_5_2 import conv_layer, deconv_layer, InteractorT, Interactor, MLP, CrossAttention, SelfAttention, GateBridgerFormer as BridgerFormer
    ...
    def forward(self, img, text, backbone):
        ...
        for i in range(self.num_layers):
            if i not in [3,5,7,9,11]:
                ...
                tgt, v, t, attn = self.bridgeformer[stage_i](tgt+reg, v, t, pos_query=None, return_attn=True)
