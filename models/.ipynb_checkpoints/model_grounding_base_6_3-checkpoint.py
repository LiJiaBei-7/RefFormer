...
from models.layers_6_3 import GA, MLP, CrossAttention, HA #HA2 as HA
from models.Bridger_6_3 import Bridger_ViT_1 as Bridger_VL_1
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.de_pos = nn.Embedding(self.bridger.n_reg, dim_ffn)
