...
from models.Bridger_3_9 import Bridger_ViT_1 as Bridger_VL_1
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.decoder_pos = nn.Embedding(1,dim_ffn)
    ...
    def forward(self, image, text_ids, targets=None, idx=None, text=None, epoch=None, training=False):
        ...
        fq, attn = self.decoder(reg_token, fq, word, pad_mask=pad_mask, query_pos=None, return_attn=True) # torch.Size([32, 512, 257])
