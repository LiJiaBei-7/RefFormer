...
from models.layers_3_7 import HA1 as HA, GA, MLP, CrossAttention
from models.Bridger_3_7 import Bridger_ViT_1 as Bridger_VL_1
...
#             with h5py.File('attn_data/Bridger_3_7_4610_avg.hdf5', 'a') as f:
...
#         if torch.distributed.get_rank() == 0:
#             with h5py.File('attn_data/decoder_attn/Bridger_3_7_4610_avg.hdf5', 'a') as f:
#                 for i in range(len(idx)):
#                     if str(idx[i].item()) not in f.keys():
