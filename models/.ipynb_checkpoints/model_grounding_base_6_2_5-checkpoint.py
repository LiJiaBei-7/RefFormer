...
from models.layers_6_2_5 import GA, MLP, CrossAttention, HA #HA2 as HA
from models.Bridger_6_2_5 import Bridger_ViT_1 as Bridger_VL_1
...
class Model(nn.Module):
    ...
    def forward(self, image, text_ids, targets=None, idx=None, text=None, epoch=None, training=False):
        ...
        fq = self.neck(vis, state, feat_ls)
